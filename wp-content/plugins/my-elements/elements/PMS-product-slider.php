...
class ML_PMS_Product_Slider extends Widget_Base
{
	...
	{
		return 'ml-pms-product-slider';
	}
	public function get_title()
	{
		return __('PMS Product Slider ', 'my-elements');
	}
...
?>
		<style>
			.pms-product-slider .product-slide {
				padding: 20px;
				border-radius: 20px;
			...
			.pms-product-slider .product-slide .slide-img {
				flex-shrink: 0;
			}

			.pms-product-slider .product-slide h3 {
				font-size: 20px;
				font-weight: 700;
				margin-left: 8px;
			}

			.pms-product-slider .product-slide .slide-content {
				padding: 0;
			}
		</style>

		<div class="section-procuct">
			<div class="owl-carousel pms-product-slider">
				<?php
					...
					<div class="product-slide">
						...
						<div class="slide-content">
							<?php if (!empty($item['title_text'])) {
								echo '<h3 class="title_text">' . esc_html($item['title_text']) . '</h3>';
							}
